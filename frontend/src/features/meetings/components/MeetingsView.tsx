...
const MeetingsView = () => {
    ...
    const { upcoming, past, isLoading, error, refetch, rsvp } = useMeetings();
            ...
            <div className="max-w-4xl mx-auto py-8">
                <div className="mb-12">
                    ...
                    <p className="text-zinc-500 dark:text-zinc-400 mt-2 text-lg font-medium leading-relaxed">
                        Join your streams for regular fellowship, prayer, and kingdom collaboration.
                    </p>
                </div>
                    ...
                    <div className="space-y-6">
                        {upcoming.map(meeting => (
                            <MeetingCard 
                                ...
                                meeting={meeting} 
                                onRSVP={rsvp}
                                onCheckIn={(m) => console.log('Check-in:', m.id)}
