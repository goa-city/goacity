        ...
        <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-slate-900 border border-slate-800 p-10 rounded-[32px] shadow-2xl">
                    ...
                    {error && (
                        <div className="mb-6 bg-rose-500/10 border border-rose-500/20 text-rose-400 text-[11px] font-black uppercase tracking-widest p-4 rounded-xl flex items-center gap-3">
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="pt-4">
                            <button
                                type="submit"
                                className="group relative flex w-full justify-center rounded-xl bg-sky-500 py-4 text-[11px] font-black text-white hover:bg-sky-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 uppercase tracking-[0.2em] transition-all shadow-xl shadow-sky-500/20 active:scale-[0.98]"
                            >
