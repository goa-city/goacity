...
const MentorshipStart: React.FC = () => {
    ...
    const activeCount = asMentee.filter((r: any) => r.status === 'Active').length;
    const pendingCount = asMentee.filter((r: any) => r.status === 'Requested').length;
    const hideFindMentor = activeCount >= 2 || pendingCount >= 2;

    const hasRelationships = relations.length > 0;

    const handleFindMentorClick = () => {
        if (pendingCount >= 2) {
            alert("You already have 2 pending requests.");
            return;
        }
        if (activeCount >= 2) {
            alert("You already have 2 active mentorships.");
            return;
        }
        ...
        <DashboardLayout>
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                ...
                <div className="flex items-center gap-3">
                    {hasRelationships && !hideFindMentor && (
                        <button
            ...
            {!hasRelationships && (
                <div className="animate-fadeIn">
                    ...
                    <div className="flex flex-col items-center bg-zinc-50 border border-zinc-100 rounded-[2.5rem] p-12 text-center shadow-inner mb-16">
                        ...
                        >
                            ...
                            <MentorshipIcon className="w-5 h-5 animate-bounce" />
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        <div className="bg-white p-10 rounded-[2rem] shadow-md border border-gray-100 hover:scale-102 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-zinc-900  mb-3">Intentional Growth</h3>
                        ...
                        <div className="bg-white p-10 rounded-[2rem] shadow-md border border-gray-100 hover:scale-102 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-zinc-900  mb-3">Covenant Pairing</h3>
                            <p className="text-zinc-500 text-sm leading-relaxed">
                        ...
                        <div className="bg-white p-10 rounded-[2rem] shadow-md border border-gray-100 hover:scale-102 transition-transform duration-300">
                            ...
                            <h3 className="text-xl font-bold text-zinc-900  mb-3">Wisdom Transfer</h3>
                            <p className="text-zinc-500 text-sm leading-relaxed">
