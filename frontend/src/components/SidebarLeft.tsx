        ...
        <>
            ...
            `}>
                ...
                <div className="flex flex-col items-center px-6 mb-8 text-center mt-4">
                    ...
                    <h2 className="mt-6 text-sm font-black text-zinc-900 dark:text-white uppercase tracking-widest">
                        {user?.first_name ? `${user.first_name} ${user.last_name || ''}` : 'City Member'}
                    </h2>
                    <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mt-1">{user?.email}</p>
                </div>
                    ...
                    {navigation.map((item) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex items-center w-full px-4 py-3 text-[11px] font-black uppercase tracking-widest rounded-xl transition-all ${
                                    active 
