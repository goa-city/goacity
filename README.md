...
### 👥 Member Portal
- **Dashboard & News**: Real-time updates and community announcements.
- **Networking**: "My People" directory and Public Profiles to foster connections.
- **Development**:
    - **Mentorship**: Connect with mentors and manage professional growth.
    - **Stewardship**: Track and verify community contributions (financial and skills-based).
    - **Idea Lab**: An incubator for community projects and startup ideas.
- **Utility**:
...
- **Editors**: Rich Text integration via React Quill
...
- **Database**: PostgreSQL
- **ORM**: Prisma 6
- **Communications**: Resend API for transactional emails
